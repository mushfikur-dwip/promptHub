  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="md:col-span-1">
                ...
                <div className="mb-6 max-w-xl">
                  {/* <h2 className="font-semibold mb-4">Prompt Image</h2> */}
                  {prompt.image_url ? (
                    <img
        ...
        <div className="py-8">
          <div className="container mx-auto px-4 max-w-7xl bg-[#F7F8FA] backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20 sticky top-8">
            <RatingSystem
